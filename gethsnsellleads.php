...
if (isset($_SERVER['HTTP_ORIGIN'])) {
	...
	$hsn_id = substr($hsn_id,0,6);
        ...
        $sql = "select *,(select count(*) from myfav_hscodes where user_id='$user_id' and hscode=leads.hsn_id) as hsstate from leads where hsn_id like '$hsn_id%' and lead_type='Sell' and status=1";
